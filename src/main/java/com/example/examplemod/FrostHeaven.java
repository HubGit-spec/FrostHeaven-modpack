...
public class FrostHeaven {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> Tab = CREATIVE_MODE_TABS.register("example_tab", () -> CreativeModeTab.builder()
            .title(Component.translatable("itemGroup.fh")) //The language key for the title of your CreativeModeTab
            .withTabsBefore(CreativeModeTabs.COMBAT)
            .icon(() -> ModItems.ICE_SHARD.get().getDefaultInstance())
            .displayItems((parameters, output) -> {
                output.accept(EXAMPLE_BLOCK.get()); // Add the example item to the tab. For your own tabs, this method is preferred over the event
            }).build());
    ...
    @EventBusSubscriber(modid = FrostHeaven.MODID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
